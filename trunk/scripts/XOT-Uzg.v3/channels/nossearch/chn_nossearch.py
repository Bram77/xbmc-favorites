...
class Channel(chn_nos.Channel):
    ...
    def ParseMainList(self):
        ...
        searchItem = common.clistItem("Zoek in www.uitzendinggemist.nl", "searchSite")
        searchItem.icon = self.icon
        items.append(searchItem)
        
        newItem = common.clistItem("Nieuw toegevoegd", "newItems")
        newItem.icon = self.icon
        items.append(newItem)        
        
        popItem = common.clistItem("Populaire uitzendingen","popularItems")
        popItem.icon = self.icon
        items.append(popItem)        
        
        tipItem = common.clistItem("Eerdere Tips","tipItems")
