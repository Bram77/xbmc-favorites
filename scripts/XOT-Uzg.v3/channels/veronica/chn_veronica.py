...
#        self.listItems[selectedIndex] = self.DownloadEpisode(item)
    ...
    def UpdateVideoItem(self, item):
        ...
        # now the mediaurl is derived
                                                    #http://asx.sbsnet.nl/veronicatv/waarisdemol_S01/waarisdemol_S01E06.wmv -> Gives the ASX 
        #http://www.garnierstreamingmedia.com/asx/openclip.asp?file=/sbs6/veronicatv/waarisdemol_S01/waarisdemol_S01E06.wmv
        #http://www.garnierstreamingmedia.com/asx/openclip.asp?file=/sbs6/veronicatv/eyeopener_S01/eyeopener_S01E02.wmv"
        
        data = uriHandler.Open(item.url, pb=False)
        urls = common.DoRegexFindAll('<a class="wmv-player-holder" href="(http://asx.sbsnet.nl/veronicatv)(/[^"]+)"></a>', data)
        
        for url in urls:
            item.mediaurl = "http://www.garnierstreamingmedia.com/asx/openclip.asp?file=/sbs6/veronicatv%s" % (url[1])
